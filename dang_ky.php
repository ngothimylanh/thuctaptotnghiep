...
<div class="panel panel-primary"; style="border: 0.1px solid #ec522b;">
    <div class="panel-heading"; style="cursor: pointer; border: 0.1px solid #ec522b; background-color: #ec522b;">Đăng ký</div>
	...
	<table class="table">
		<tr>
			<td><label for="user">Tên đăng nhập:</label> <span style="color: red;">(*)</span></td>
		...
		<tr>
			<td><label for="tinhtp">Tỉnh/Thành phố:</label> <span style="color: red;">(*)</span></td>
			<td>
...
<div class="button-container">
    <input type="submit" class="btn btn-dangky" name="submit" value="Đăng ký">
<form action="?menu=exec_dang_ky" method="post">
    <input type="submit" class="btn btn-huy" name="cancel" value="Hủy">
</form>
</div>
	</form>
	</div>
