<?php
	if(!isset($login)){exit();}
?>
<table style="width:90%;margin-left:55px; border-collapse: collapse;">
<tr align="center">
<p style="font-weight: bold; font-size: 25px;text-align: center; margin-top:40px;">CHI TIẾT SẢN PHẨM </p>
<?php 
	include('../connect.php');
