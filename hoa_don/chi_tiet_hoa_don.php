...
<p style="font-weight: bold; font-size: 25px;text-align: center; margin-top:40px;">CHI TIẾT HOÁ ĐƠN</p>
	...
	<tr>
		<td colspan="2" class="title" style="text-align: center;font-weight: bold; background-color:#337ab7">THÔNG TIN KHÁCH HÀNG</td>
	</tr>
	<tr>
...
<table style="width:92%;margin-left:55px; border-collapse: collapse;">
	<tr>
		<td colspan="4" class="title" style="text-align: center;font-weight: bold; background-color:#337ab7;">THÔNG TIN SẢN PHẨM ĐÃ ĐẶT HÀNG</td>
	</tr>
	<tr>
		<td>Tên sản phẩm</td>
		<td>Đơn giá</td>
	...
	<tr>
		...
		<td><?php echo '<span style="color: #5289d1;" >'.$row['xu_ly'].'</span>'; ?></td>
		<td><a style="text-decoration: none; padding: 5px 15px; background-color:#337ab7; color: #fffafa;" href="?menu=xu_ly&ma_hoadon=<?php echo $row['ma_hoadon']; ?>">Xử lý</a></td>
		<td><a style="text-decoration: none; padding: 5px 15px; background-color: #337ab7; color: #fffafa;"  onclick="return confirm('Bạn có mún xóa hóa đơn?');"  href="?menu=xoa&ma_hoadon=<?php echo $row['ma_hoadon']; ?>">Xóa hóa đơn</a></td>
	</tr>
</table>